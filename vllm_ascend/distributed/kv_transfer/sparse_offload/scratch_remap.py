...
def scratch_remap(
    ...
    Returns:
        new_indices: same shape as topk_indices. LMCache-selected entries are
            replaced by their compact scratch row (rank in top-k order); live
            decode entries are mapped to the configured resident decode window;
            padding entries stay unchanged.
