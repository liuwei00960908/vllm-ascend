...
def main():
    ...
    try:
        ...
        raise RuntimeError(
            "vllm_ascend_C does not contain npu_dsa_scratch_remap_; rebuild the extension before running this benchmark"
        ) from exc
    ...
    def fused():
        ...
        fused_op(fused_topk, split_boundary, valid_rows, scratch_base, True)
